...
class TagManagerCLITest(unittest.TestCase):
    ...
    def test_run_upsert_tags_should_call_processor_upsert(self, mock_tag_datasource_processor):
    ...
    @mock.patch(
        'datacatalog_tag_manager.tag_manager_cli.tag_datasource_processor.TagDatasourceProcessor')
    def test_run_delete_tags_should_call_processor_delete(self, mock_tag_datasource_processor):
