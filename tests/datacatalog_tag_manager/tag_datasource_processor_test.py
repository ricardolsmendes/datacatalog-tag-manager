...
class TagDatasourceProcessorTest(unittest.TestCase):
    ...
    def test_upsert_tags_from_csv_column_metadata_should_succeed(self, mock_read_csv):
        ...
        created_tag_1 = upserted_tags[0]  # Tags with no column information are created first.
    ...
    def test_upsert_tags_from_csv_invalid_argument_lookup_entry_should_skip_record(
            self, mock_read_csv):
    ...
    def test_upsert_tags_from_csv_permission_denied_lookup_entry_should_skip_record(
            self, mock_read_csv):
    ...
    def test_upsert_tags_from_csv_permission_denied_get_entry_should_skip_record(
            self, mock_read_csv):
    ...
    def test_upsert_tags_from_csv_permission_denied_get_template_should_skip_record(
            self, mock_read_csv):
