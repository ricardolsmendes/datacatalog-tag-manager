...
class TagDatasourceProcessorTest(unittest.TestCase):
    ...
    def test_create_tags_from_csv_should_skip_nan_field_values(self, mock_read_csv):
        # Pandas is not aware of the field types, so it reads empty all values as NaN.
        mock_read_csv.return_value = pd.DataFrame(
            data={
